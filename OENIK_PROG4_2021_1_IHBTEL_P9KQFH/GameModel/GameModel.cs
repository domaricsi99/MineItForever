...
namespace GameModelDll
{
    public class GameModel
    {
        ...
        public GameModel()
        {
            ...
            this.PickaxShop = new Shape((Config.BuildingWidth / 2) - 10, this.PickaxShopHouse.Area.Y, Config.ShopWidth, Config.ShopHeight);
            this.HealthShop = new Shape(this.HealthShopHouse.Area.X + (Config.BuildingWidth / 2) - 20, this.HealthShopHouse.Area.Y, Config.ShopWidth, Config.ShopHeight);
            this.PetrolShop = new Shape(this.PetrolShopHouse.Area.X + (Config.BuildingWidth / 2) - 20, this.PetrolShopHouse.Area.Y, Config.ShopWidth, Config.ShopHeight);
